...
usage =    "ghc-hare version " ++ showVersion version ++ "\n"
        ...
        ++ "\t ghc-hare maybetomp"      ++ ghcOptHelp ++ "filename line col  functionname argumentnumber\n"
        ++ "\t ghc-hare help\n"
...
main = flip catches handlers $ do
    ...
    res <- case cmdArg0 of
      ...
      "maybetomp" -> runFunc $ maybeToMonadPlus opt defaultOptions cmdArg1 (parseSimpPos cmdArg2 cmdArg3) cmdArg4 cmdArg5
