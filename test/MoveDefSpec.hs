...
-}
  ...
  describe "LiftOneLevel" $ do
    ...
    it "LiftOneLevel WhereIn6 13 29" $ do
     liftOneLevel defaultTestSettings Nothing "./test/testdata/LiftOneLevel/WhereIn6.hs" (13,29)
     -- liftOneLevel logTestSettings  Nothing "./test/testdata/LiftOneLevel/WhereIn6.hs" (13,29)
    ...
    it "LiftOneLevel WhereIn7 12 14" $ do
     liftOneLevel defaultTestSettings Nothing "./test/testdata/LiftOneLevel/WhereIn7.hs" (12,14)
     -- liftOneLevel logTestSettings  Nothing "./test/testdata/LiftOneLevel/WhereIn7.hs" (12,14)
    ...
    it "LiftOneLevel LetIn1 11 22" $ do
     liftOneLevel defaultTestSettings Nothing "./test/testdata/LiftOneLevel/LetIn1.hs" (11,22)
     -- liftOneLevel logTestSettings  Nothing "./test/testdata/LiftOneLevel/LetIn1.hs" (11,22)
    ...
    it "LiftOneLevel CaseIn1 10 28" $ do
     liftOneLevel defaultTestSettings Nothing "./test/testdata/LiftOneLevel/CaseIn1.hs" (10,28)
     -- liftOneLevel logTestSettings  Nothing "./test/testdata/LiftOneLevel/CaseIn1.hs" (10,28)
