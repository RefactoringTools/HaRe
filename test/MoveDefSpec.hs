...
spec = do
  ...
  describe "liftToTopLevel" $ do
    it "Cannot lift a top level declaration" $ do
     ...
     res <- catchException (liftToTopLevel defaultTestSettings testCradle Nothing "./test/testdata/MoveDef/Md1.hs" (4,1))
    ...
    it "checks for name clashes" $ do
     ...
     res <- catchException (liftToTopLevel defaultTestSettings testCradle Nothing "./test/testdata/MoveDef/Md1.hs" (17,5))
    ...
    it "lifts a definition to the top level" $ do
     ...
     liftToTopLevel defaultTestSettings testCradle Nothing "./test/testdata/MoveDef/Md1.hs" (24,5)
    ...
    it "liftToTopLevel D1 C1 A1 8 6" $ do
     liftToTopLevel defaultTestSettings testCradle (Just "./test/testdata/LiftToToplevel/A1.hs") "./test/testdata/LiftToToplevel/D1.hs" (8,6)
    ...
    it "liftToTopLevel D2 C2 A2 8 6" $ do
     liftToTopLevel defaultTestSettings testCradle (Just "./test/testdata/LiftToToplevel/A2.hs") "./test/testdata/LiftToToplevel/D2.hs" (8,6)
    ...
    it "liftToTopLevel D3 C3 A3 8 6" $ do
     liftToTopLevel defaultTestSettings testCradle (Just "./test/testdata/LiftToToplevel/A3.hs") "./test/testdata/LiftToToplevel/D3.hs" (8,6)
    ...
    it "liftToTopLevel WhereIn1 12 18" $ do
     liftToTopLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftToToplevel/WhereIn1.hs" (12,18)
    ...
    it "liftToTopLevel WhereIn6 13 29" $ do
     liftToTopLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftToToplevel/WhereIn6.hs" (13,29)
    ...
    it "liftToTopLevel WhereIn7 12 14" $ do
     liftToTopLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftToToplevel/WhereIn7.hs" (12,14)
    ...
    it "liftToTopLevel LetIn1 11 22" $ do
     liftToTopLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftToToplevel/LetIn1.hs" (11,22)
    ...
    it "liftToTopLevel LetIn2 10 22" $ do
     liftToTopLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftToToplevel/LetIn2.hs" (10,22)
    ...
    it "liftToTopLevel LetIn3 10 27" $ do
     liftToTopLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftToToplevel/LetIn3.hs" (10,27)
     -- liftToTopLevel logTestSettings  testCradle    Nothing "./test/testdata/LiftToToplevel/LetIn3.hs" (10,27)
    ...
    it "liftToTopLevel PatBindIn1 18 7" $ do
     liftToTopLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftToToplevel/PatBindIn1.hs" (18,7)
     -- liftToTopLevel logTestSettings  testCradle    Nothing "./test/testdata/LiftToToplevel/PatBindIn1.hs" (18,7)
    ...
    it "liftToTopLevel PatBindIn3 11 15" $ do
     liftToTopLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftToToplevel/PatBindIn3.hs" (11,15)
     -- liftToTopLevel logTestSettings  testCradle    Nothing "./test/testdata/LiftToToplevel/PatBindIn3.hs" (11,15)
    ...
    it "liftToTopLevel CaseIn1 10 28" $ do
     liftToTopLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftToToplevel/CaseIn1.hs" (10,28)
     -- liftToTopLevel logTestSettings  testCradle    Nothing "./test/testdata/LiftToToplevel/CaseIn1.hs" (10,28)
...
-}
    ...
    it "liftToTopLevel WhereIn2 11 18 fails" $ do
     ...
     res <- catchException (liftToTopLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftToToplevel/WhereIn2.hs" (11,18))
...
-}
  ...
  describe "LiftOneLevel" $ do
    ...
    it "LiftOneLevel.liftToMod D1 C1 A1 8 6" $ do
     liftOneLevel defaultTestSettings testCradle (Just "./test/testdata/LiftOneLevel/A1.hs") "./test/testdata/LiftOneLevel/D1.hs" (8,6)
    ...
    it "LiftOneLevel.liftToMod D2 C2 A2 8 6" $ do
     liftOneLevel defaultTestSettings testCradle (Just "./test/testdata/LiftOneLevel/A2.hs") "./test/testdata/LiftOneLevel/D2.hs" (8,6)
    ...
    it "LiftOneLevel.liftToMod D3 C3 A3 8 6" $ do
     liftOneLevel defaultTestSettings testCradle (Just "./test/testdata/LiftOneLevel/A3.hs") "./test/testdata/LiftOneLevel/D3.hs" (8,6)
    ...
    it "LiftOneLevel WhereIn1 12 18" $ do
     liftOneLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftOneLevel/WhereIn1.hs" (12,18)
     -- liftOneLevel logTestSettings  testCradle Nothing "./test/testdata/LiftOneLevel/WhereIn1.hs" (12,18)
    ...
    it "LiftOneLevel WhereIn6 13 29" $ do
     liftOneLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftOneLevel/WhereIn6.hs" (13,29)
     -- liftOneLevel logTestSettings  testCradle Nothing "./test/testdata/LiftOneLevel/WhereIn6.hs" (13,29)
    ...
    it "LiftOneLevel WhereIn7 12 14" $ do
     liftOneLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftOneLevel/WhereIn7.hs" (12,14)
     -- liftOneLevel logTestSettings  testCradle Nothing "./test/testdata/LiftOneLevel/WhereIn7.hs" (12,14)
    ...
    it "LiftOneLevel WhereIn8 8 11" $ do
     liftOneLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftOneLevel/WhereIn8.hs" (8,11)
     -- liftOneLevel logTestSettings  testCradle Nothing "./test/testdata/LiftOneLevel/WhereIn8.hs" (8,11)
    ...
    it "LiftOneLevel LetIn1 11 22" $ do
     liftOneLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftOneLevel/LetIn1.hs" (11,22)
     -- liftOneLevel logTestSettings  testCradle Nothing "./test/testdata/LiftOneLevel/LetIn1.hs" (11,22)
    ...
    it "LiftOneLevel LetIn2 11 22" $ do
     liftOneLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftOneLevel/LetIn2.hs" (11,22)
     -- liftOneLevel logTestSettings  testCradle Nothing "./test/testdata/LiftOneLevel/LetIn2.hs" (11,22)
    ...
    it "LiftOneLevel LetIn3 10 27" $ do
     liftOneLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftOneLevel/LetIn3.hs" (10,27)
     -- liftOneLevel logTestSettings  testCradle Nothing "./test/testdata/LiftOneLevel/LetIn3.hs" (10,27)
    ...
    it "LiftOneLevel PatBindIn3 11 15" $ do
     liftOneLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftOneLevel/PatBindIn3.hs" (11,15)
     -- liftOneLevel logTestSettings  testCradle Nothing "./test/testdata/LiftOneLevel/PatBindIn3.hs" (11,15)
    ...
    it "LiftOneLevel CaseIn1 10 28" $ do
     liftOneLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftOneLevel/CaseIn1.hs" (10,28)
     -- liftOneLevel logTestSettings  testCradle Nothing "./test/testdata/LiftOneLevel/CaseIn1.hs" (10,28)
    ...
    it "fails WhereIn2 8 18" $ do
     res <- catchException (liftOneLevel defaultTestSettings testCradle Nothing "./test/testdata/LiftOneLevel/WhereIn2.hs" (8,18))
     -- liftOneLevel logTestSettings testCradle Nothing "./test/testdata/LiftOneLevel/WhereIn2.hs" (8,18)
...
-}
  ...
  describe "demote" $ do
    ...
    it "notifies if no definition selected" $ do
     ...
     res <- catchException (demote defaultTestSettings testCradle Nothing "./test/testdata/MoveDef/Md1.hs" (14,13))
     (show res) `shouldBe` "Just \"\\nInvalid cursor position!\""

    it "will not demote if nowhere to go" $ do
     -- res <- catchException (doDemote ["./test/testdata/MoveDef/Md1.hs","8","1"])
     res <- catchException (demote defaultTestSettings testCradle Nothing "./test/testdata/MoveDef/Md1.hs" (8,1))
    ...
    it "demotes a definition from the top level 1" $ do
     ...
     demote defaultTestSettings testCradle Nothing "./test/testdata/MoveDef/Demote.hs" (7,1)
    ...
    it "demotes a definition from the top level D1" $ do
     ...
     demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/D1.hs" (9,1)
    ...
    it "demotes WhereIn1 12 1" $ do
     ...
     demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/WhereIn1.hs" (12,1)
    ...
    it "demotes WhereIn3 14 1" $ do
     ...
     demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/WhereIn3.hs" (14,1)
    ...
    it "demotes WhereIn4 14 1" $ do
     ...
     demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/WhereIn4.hs" (14,1)
    ...
    it "demotes WhereIn5 14 1" $ do
     ...
     demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/WhereIn5.hs" (14,1)
    ...
    it "demotes WhereIn6 13 1" $ do
     ...
     demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/WhereIn6.hs" (13,1)
    ...
    it "demotes WhereIn7 13 1" $ do
     ...
     demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/WhereIn7.hs" (13,1)
    ...
    it "demotes CaseIn1 16 1" $ do
     ...
     demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/CaseIn1.hs" (16,1)
    ...
    it "demotes LetIn1 12 22" $ do
     ...
     demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/LetIn1.hs" (12,22)
    ...
    it "demotes PatBindIn1 19 1" $ do
     ...
     demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/PatBindIn1.hs" (19,1)
    ...
    it "demotes D2 5 1 when not imported by other module" $ do
     ...
     demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/D2.hs" (5,1)
    ...
    it "fails WhereIn2 14 1" $ do
     ...
     res <- catchException (demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/WhereIn2.hs" (14,1))
    ...
    it "fails LetIn2 11 22" $ do
     ...
     res <- catchException (demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/LetIn2.hs" (11,22))
    ...
    it "fails PatBindIn4 18 1" $ do
     ...
     res <- catchException (demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/PatBindIn4.hs" (18,1))
     -- (show res) `shouldBe` "Just \"\\n Nowhere to demote this function!\\n\""
    ...
    it "fails WhereIn8 16 1" $ do
     ...
     res <- catchException (demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/WhereIn8.hs" (16,1))
     (show res) `shouldBe` "Just \"\\n Nowhere to demote this function!\\n\""

    -- -----------------------------------------------------------------

    it "fails D2 5 1" $ do
     res <- catchException (demote defaultTestSettings testCradle (Just "./test/testdata/Demote/A2.hs") "./test/testdata/Demote/D2.hs" (5,1))
    ...
    it "fails D3 5 1" $ do
     ...
     res <- catchException (demote defaultTestSettings testCradle Nothing "./test/testdata/Demote/D3.hs" (5,1))
