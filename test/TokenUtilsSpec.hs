...
-}
    ...
    it "retrieves the tokens in Ppr format PatBind" $ do
      ...
      (drawTreeCompact layout) `shouldBe`
          ...
          "3:((7,36),(7,38))\n"++
          "2:((8,3),(8,8))\n"++
          "2:((9,5),(10,12))(Above 1 -3 (10,10) (3,-9))\n"++
          "3:((9,5),(9,14))\n"++
          "4:((9,5),(9,7))\n"++
          "5:((9,5),(9,7))\n"++
          "4:((9,8),(9,10))\n"++
...
-}
    ...
    it "retrieves the tokens in Ppr format Md1" $ do
      ...
      (drawTreeCompact layout) `shouldBe`
          ...
          "3:((14,36),(14,38))\n"++
          "2:((15,3),(15,8))\n"++
          "2:((16,5),(17,12))(Above 1 -3 (17,10) (2,-9))\n"++
          "3:((16,5),(16,14))\n"++
          "4:((16,5),(16,7))\n"++
          "5:((16,5),(16,7))\n"++
          "4:((16,8),(16,10))\n"++
          ...
          "5:((22,12),(22,14))\n"++
          "4:((23,3),(23,8))\n"++
          "4:((24,5),(24,11))(Above 1 -3 (24,10) (2,-9))\n"++
          "5:((24,5),(24,11))\n"++
          "6:((24,5),(24,11))\n"++
          "7:((24,5),(24,7))\n"++
          "7:((24,8),(24,11))\n"++
          ...
          "4:((27,3),(29,12))\n"++
          "5:((27,3),(27,6))\n"++
          "5:((28,5),(28,12))(Above 1 -1 (28,10) (1,-7))\n"++
          "6:((28,5),(28,12))\n"++
          "7:((28,5),(28,12))\n"++
          "8:((28,5),(28,7))\n"++
          "8:((28,8),(28,12))\n"++
          ...
          "5:((32,3),(32,13))\n"++
          "6:((32,3),(32,6))\n"++
          "6:((32,7),(32,13))(Above 0 1 (32,12) (1,-9))\n"++
          "7:((32,7),(32,13))\n"++
          "8:((32,7),(32,13))\n"++
          "9:((32,7),(32,9))\n"++
          "9:((32,10),(32,13))\n"++
