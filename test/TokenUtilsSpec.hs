...
-}
    ...
    it "retrieves the tokens in Ppr format LetStmt" $ do
      ...
      (drawTreeCompact layout) `shouldBe`
          ...
          "5:((5,7),(7,18))\n"++
          "6:((5,7),(6,12))\n"++
          "6:((6,13),(7,18))(Above 0 1 (6,13) (7,17) (1,-8))\n"++
          "7:((6,13),(6,18))\n"++
          "8:((6,13),(6,18))\n"++
          "9:((6,13),(6,14))\n"++
          "9:((6,15),(6,18))\n"++
    ...
    it "retrieves the tokens in Ppr format LayoutIn2" $ do
      ...
      (drawTreeCompact layout) `shouldBe`
          ...
          "5:((8,19),(8,23))\n"++
          "5:((8,24),(8,26))\n"++
          "5:((8,28),(12,43))(Above 0 2 (8,28) (12,41) (0,0))\n"++
          "6:((8,28),(8,39))\n"++
          "7:((8,28),(8,34))\n"++
          "8:((8,28),(8,34))\n"++
          "7:((8,35),(8,37))\n"++
          ...
          "8:((11,45),(11,46))\n"++
          "7:((11,48),(11,53))\n"++
          "7:((11,55),(11,66))(Above 0 2 (11,55) (11,64) (1,-36))\n"++
          "8:((11,55),(11,66))\n"++
          "9:((11,55),(11,66))\n"++
          "10:((11,55),(11,56))\n"++
          "10:((11,57),(11,66))\n"++
...
{-
          ...
          "4:((8,14),(12,43))\n"++
           ...
           "5:((8,19),(8,23))\n"++
           "5:((8,24),(8,26))\n"++
           "5:((8,28),(12,43))(Above 0 2 (8,28) (12,41) (2,-40))\n"++
            "6:((8,28),(8,39))\n"++
             "7:((8,28),(8,34))\n"++
              "8:((8,28),(8,34))\n"++
             "7:((8,35),(8,37))\n"++
...
-}
    ...
    it "retrieves the tokens in Ppr format PatBind" $ do
      ...
      (drawTreeCompact layout) `shouldBe`
          ...
          "3:((7,36),(7,38))\n"++
          "2:((8,3),(8,8))\n"++
          "2:((9,5),(10,12))(Above 1 -3 (9,5) (10,10) (0,0))\n"++
          "3:((9,5),(9,14))\n"++
          "4:((9,5),(9,7))\n"++
          "5:((9,5),(9,7))\n"++
          "4:((9,8),(9,10))\n"++
...
-}
    ...
    it "retrieves the tokens in Ppr format Md1" $ do
      ...
      (drawTreeCompact layout) `shouldBe`
          ...
          "5:((22,12),(22,14))\n"++
          "4:((23,3),(23,8))\n"++
          "4:((24,5),(24,11))(Above 1 -3 (24,5) (24,10) (2,-9))\n"++
          "5:((24,5),(24,11))\n"++
          "6:((24,5),(24,11))\n"++
          "7:((24,5),(24,7))\n"++
          "7:((24,8),(24,11))\n"++
          ...
          "4:((27,3),(29,12))\n"++
          "5:((27,3),(27,6))\n"++
          "5:((28,5),(28,12))(Above 1 -1 (28,5) (28,10) (1,-7))\n"++
          "6:((28,5),(28,12))\n"++
          "7:((28,5),(28,12))\n"++
          "8:((28,5),(28,7))\n"++
          "8:((28,8),(28,12))\n"++
          ...
          "5:((31,8),(32,13))\n"++
          "6:((31,8),(32,6))\n"++
          "6:((32,7),(32,13))(Above 0 1 (32,7) (32,12) (1,-9))\n"++
          "7:((32,7),(32,13))\n"++
          "8:((32,7),(32,13))\n"++
          "9:((32,7),(32,9))\n"++
          "9:((32,10),(32,13))\n"++
...
-}
  ...
  describe "replaceTokenForSrcSpan" $ do
    ...
    it "replaces a single token in an added span" $ do
      ...
      (drawTreeCompact f1) `shouldBe` "0:((1,1),(34,1))\n1:((1,1),(1,7))\n1:((1,8),(1,18))\n1:((1,19),(1,24))\n1:((3,1),(3,9))\n2:((3,1),(3,9))\n1:((3,10),(3,12))\n1:((3,13),(3,20))\n1:((3,21),(3,23))\n1:((3,24),(3,31))\n1:((4,1),(4,19))\n2:((4,1),(4,19))\n3:((4,1),(4,9))\n3:((4,10),(4,19))\n4:((4,10),(4,11))\n5:((4,10),(4,11))\n4:((4,12),(4,13))\n4:((4,14),(4,19))\n5:((4,14),(4,15))\n5:((4,16),(4,17))\n5:((4,18),(4,19))\n1:((6,1),(6,2))\n2:((6,1),(6,2))\n1:((6,2),(6,3))\n1:((6,3),(6,4))\n2:((6,3),(6,4))\n1:((6,5),(6,7))\n1:((6,8),(6,15))\n1:((7,1),(7,6))\n2:((7,1),(7,6))\n3:((7,1),(7,2))\n3:((7,3),(7,6))\n4:((7,3),(7,4))\n4:((7,5),(7,6))\n5:((7,5),(7,6))\n1:((8,1),(8,6))\n2:((8,1),(8,6))\n3:((8,1),(8,2))\n3:((8,3),(8,6))\n4:((8,3),(8,4))\n4:((8,5),(8,6))\n5:((8,5),(8,6))\n1:((11,1),(11,4))\n2:((11,1),(11,4))\n1:((11,5),(11,7))\n1:((11,8),(11,9))\n1:((11,9),(11,12))\n2:((11,9),(11,12))\n1:((11,12),(11,13))\n1:((11,14),(11,17))\n2:((11,14),(11,17))\n1:((11,17),(11,18))\n1:((12,1),(12,2))\n2:((12,1),(12,2))\n1:((12,3),(12,5))\n1:((12,6),(12,9))\n1:((13,1),(13,2))\n2:((13,1),(13,2))\n1:((13,3),(13,5))\n1:((13,6),(13,9))\n1:((14,1),(17,12))\n2:((14,1),(14,10))\n2:((14,11),(14,12))\n2:((14,13),(14,38))\n3:((14,13),(14,17))\n3:((14,18),(14,19))\n3:((14,20),(14,23))\n3:((14,24),(14,25))\n3:((14,25),(14,26))\n3:((14,28),(14,30))\n3:((14,32),(14,33))\n3:((14,33),(14,34))\n3:((14,36),(14,38))\n2:((15,3),(15,8))\n2:((16,5),(17,12))(Above 1 -3 (16,5) (17,10) (2,-9))\n3:((16,5),(16,14))\n4:((16,5),(16,7))\n5:((16,5),(16,7))\n4:((16,8),(16,10))\n4:((16,11),(16,14))\n3:((17,5),(17,12))\n4:((17,5),(17,12))\n5:((17,5),(17,7))\n5:((17,8),(17,12))\n6:((17,8),(17,9))\n6:((17,10),(17,12))\n7:((17,10),(17,12))\n1:((19,1),(19,5))\n1:((19,6),(19,7))\n1:((19,8),(19,9))\n1:((19,10),(19,11))\n2:((19,10),(19,11))\n1:((19,12),(19,13))\n1:((19,14),(19,22))\n2:((19,14),(19,15))\n2:((19,16),(19,22))\n3:((19,16),(19,22))\n1:((19,23),(19,24))\n1:((19,25),(19,26))\n2:((19,25),(19,26))\n1:((21,1),(23,11))\n2:((21,1),(23,11))\n3:((21,1),(21,3))\n3:((21,4),(23,11))\n4:((21,4),(21,5))\n5:((21,4),(21,5))\n4:((21,6),(21,7))\n4:((21,8),(21,14))\n5:((21,8),(21,9))\n5:((21,10),(21,11))\n5:((21,12),(21,14))\n4:((22,3),(22,8))\n4:((23,5),(23,11))(Above 1 -3 (23,5) (23,10) (2,-9))\n5:((23,5),(23,11))\n6:((23,5),(23,11))\n7:((23,5),(23,7))\n7:((23,8),(23,11))\n8:((23,8),(23,9))\n8:((23,10),(23,11))\n9:((23,10),(23,11))\n1:((25,1),(28,12))\n2:((25,1),(28,12))\n3:((25,1),(25,2))\n3:((25,3),(28,12))\n4:((25,3),(25,4))\n5:((25,3),(25,4))\n4:((25,5),(25,6))\n4:((26,3),(28,12))\n5:((26,3),(26,6))\n5:((27,5),(27,12))(Above 1 -1 (27,5) (27,10) (1,-7))\n6:((27,5),(27,12))\n7:((27,5),(27,12))\n8:((27,5),(27,7))\n8:((27,8),(27,12))\n9:((27,8),(27,9))\n9:((27,10),(27,12))\n10:((27,10),(27,12))\n5:((28,6),(28,12))\n6:((28,6),(28,8))\n6:((28,9),(28,10))\n6:((28,11),(28,12))\n1:((30,1),(32,18))\n2:((30,1),(32,18))\n3:((30,1),(30,3))\n3:((30,4),(32,17))\n4:((30,4),(30,5))\n5:((30,4),(30,5))\n4:((30,6),(30,7))\n4:((30,8),(32,17))\n5:((30,8),(31,13))\n6:((30,8),(31,6))\n6:((31,7),(31,13))(Above 0 1 (31,7) (31,12) (1,-9))\n7:((31,7),(31,13))\n8:((31,7),(31,13))\n9:((31,7),(31,9))\n9:((31,10),(31,13))\n10:((31,10),(31,11))\n10:((31,12),(31,13))\n11:((31,12),(31,13))\n5:((32,3),(32,17))\n6:((32,3),(32,9))\n6:((32,10),(32,11))\n6:((32,11),(32,13))\n6:((32,14),(32,15))\n6:((32,16),(32,17))\n1:((34,1),(34,1))\n"
  ...
  describe "addToksAfterSrcSpan" $ do
    ...
    it "adds a new SrcSpan after an existing one in the forest, in a where clause." $ do
      ...
      (drawTreeCompact forest) `shouldBe`
          ...
          "5:((3,21),(3,22))\n"++
          "4:((4,6),(4,11))\n"++
          "4:((4,12),(4,22))(Above 0 1 (4,12) (4,21) (0,0))\n"++
           "5:((4,12),(4,22))\n"++
            "6:((4,12),(4,22))\n"++
             "7:((4,12),(4,14))\n"++
             "7:((4,15),(4,22))\n"++
