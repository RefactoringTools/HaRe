  ...
  describe "retrieveTokensPpr" $ do
    it "retrieves the tokens in Ppr format LetExpr" $ do
      ...
      (drawTreeCompact layout) `shouldBe`
          ...
          "4:((5,7),(7,15))\n"++
          "5:((5,7),(5,10))\n"++ -- 'let' token
          "5:((5,11),(6,16))(Above 0 1 (6,15) (1,-8))\n"++ -- the grouped expressions
           "6:((5,11),(5,16))\n"++
            "7:((5,11),(5,16))\n"++
             "8:((5,11),(5,12))\n"++
             "8:((5,13),(5,16))\n"++
    ...
    it "retrieves the tokens in Ppr format PatBind" $ do
      ...
      (drawTreeCompact layout) `shouldBe`
          ...
          "1:((7,13),(7,38))\n"++
           ...
           "2:((7,36),(7,38))\n"++
          "1:((8,3),(9,14))\n"++
          "1:((10,5),(10,12))(Above 2 -3 (10,10) (3,-9))\n"++
           "2:((10,5),(10,12))\n"++
            "3:((10,5),(10,12))\n"++
             "4:((10,5),(10,7))\n"++
             "4:((10,8),(10,12))\n"++
      ...
      (show pprVal) `shouldBe`
          ...
          "PprText 4 1 [((((0,0),(0,0)),ITvocurly),\"\"),((((0,0),(0,3)),ITvarid \"tup\"),\"tup\"),((((0,4),(0,6)),ITdcolon),\"::\"),"++
                       "((((0,7),(0,8)),IToparen),\"(\"),((((0,8),(0,11)),ITconid \"Int\"),\"Int\"),((((0,11),(0,12)),ITcomma),\",\"),"++
                       "((((0,13),(0,16)),ITconid \"Int\"),\"Int\"),((((0,16),(0,17)),ITcparen),\")\")],"++
          "PprText 5 1 [((((0,0),(0,0)),ITsemi),\"\"),((((0,0),(0,1)),ITvarid \"h\"),\"h\"),((((0,2),(0,4)),ITdcolon),\"::\"),"++
                       "((((0,5),(0,8)),ITconid \"Int\"),\"Int\")],"++
          "PprText 6 1 [((((0,0),(0,0)),ITsemi),\"\"),((((0,0),(0,1)),ITvarid \"t\"),\"t\"),((((0,2),(0,4)),ITdcolon),\"::\"),"++
                       "((((0,5),(0,8)),ITconid \"Int\"),\"Int\")],"++
          "PprText 7 1 [((((0,0),(0,0)),ITsemi),\"\"),((((0,0),(0,3)),ITvarid \"tup\"),\"tup\"),((((0,3),(0,4)),ITat),\"@\"),"++
                       "((((0,4),(0,5)),IToparen),\"(\"),((((0,5),(0,6)),ITvarid \"h\"),\"h\"),((((0,6),(0,7)),ITcomma),\",\"),"++
                       "((((0,7),(0,8)),ITvarid \"t\"),\"t\"),((((0,8),(0,9)),ITcparen),\")\"),((((0,10),(0,11)),ITequal),\"=\"),"++
                      "((((0,12),(0,16)),ITvarid \"head\"),\"head\"),((((0,17),(0,18)),ITvarsym \"$\"),\"$\"),((((0,19),(0,22)),ITvarid \"zip\"),\"zip\"),"++
                      "((((0,23),(0,24)),ITobrack),\"[\"),((((0,24),(0,25)),ITinteger 1),\"1\"),((((0,25),(0,27)),ITdotdot),\"..\"),"++
                      "((((0,27),(0,29)),ITinteger 10),\"10\"),((((0,29),(0,30)),ITcbrack),\"]\"),((((0,31),(0,32)),ITobrack),\"[\"),"++
                      "((((0,32),(0,33)),ITinteger 3),\"3\"),((((0,33),(0,35)),ITdotdot),\"..\"),((((0,35),(0,37)),ITvarid \"ff\"),\"ff\"),"++
                      "((((0,37),(0,38)),ITcbrack),\"]\")],"++
          "PprText 9 5 [((((0,0),(0,0)),ITvocurly),\"\"),((((0,0),(0,2)),ITvarid \"ff\"),\"ff\"),((((0,3),(0,5)),ITdcolon),\"::\"),((((0,6),(0,9)),ITconid \"Int\"),\"Int\")],"++
          "PprAbove 2 (-3) (10,10) (3,-9) "++
  ...
  describe "replaceTokenForSrcSpan" $ do
    it "replaces a single token in a given span, without disturbing the tree" $ do
      ...
      (drawTreeCompact forest') `shouldBe`
         "0:((1,1),(26,1))\n1:((1,1),(1,7))\n1:((1,8),(1,17))\n1:((1,18),(3,32))\n1:((5,1),(6,14))\n2:((5,1),(6,14))\n3:((5,1),(5,4))\n3:((5,5),(6,14))\n4:((5,5),(5,6))\n5:((5,5),(5,6))\n4:((5,7),(5,8))\n5:((5,7),(5,8))\n4:((5,9),(5,10))\n4:((5,11),(5,12))\n5:((5,11),(5,12))\n4:((6,3),(6,8))\n4:((6,9),(6,14))(Above 0 1 (6,13) (2,-12))\n5:((6,9),(6,14))\n6:((6,9),(6,14))\n7:((6,9),(6,10))\n7:((6,11),(6,14))\n8:((6,11),(6,12))\n8:((6,13),(6,14))\n9:((6,13),(6,14))\n1:((8,1),(10,10))\n2:((8,1),(10,10))\n3:((8,1),(8,4))\n3:((8,5),(10,10))\n4:((8,5),(8,6))\n5:((8,5),(8,6))\n4:((8,7),(8,8))\n5:((8,7),(8,8))\n4:((8,9),(8,10))\n4:((8,11),(8,12))\n5:((8,11),(8,12))\n4:((9,3),(9,8))\n4:((10,5),(10,10))(Above 1 -3 (10,9) (3,-8))\n5:((10,5),(10,10))\n6:((10,5),(10,10))\n7:((10,5),(10,6))\n7:((10,7),(10,10))\n8:((10,7),(10,8))\n8:((10,9),(10,10))\n9:((10,9),(10,10))\n1:((13,1),(15,17))\n2:((13,1),(15,17))\n3:((13,1),(13,4))\n3:((13,5),(15,17))\n4:((13,5),(13,6))\n5:((13,5),(13,6))\n4:((13,7),(13,8))\n5:((13,7),(13,8))\n4:((13,9),(13,10))\n4:((14,3),(15,17))\n5:((14,3),(14,6))\n5:((14,7),(14,14))(Above 0 1 (14,13) (1,-10))\n6:((14,7),(14,14))\n7:((14,7),(14,14))\n8:((14,7),(14,10))\n8:((14,11),(14,14))\n9:((14,11),(14,12))\n9:((14,13),(14,14))\n10:((14,13),(14,14))\n5:((15,3),(15,5))\n5:((15,10),(15,17))\n6:((15,10),(15,11))\n6:((15,12),(15,13))\n6:((15,14),(15,17))\n1:((15,18),(18,19))\n1:((19,1),(21,14))\n2:((19,1),(21,14))\n3:((19,1),(19,4))\n3:((19,5),(21,14))\n4:((19,5),(19,6))\n5:((19,5),(19,6))\n4:((19,7),(19,8))\n5:((19,7),(19,8))\n4:((19,9),(19,10))\n4:((20,3),(21,14))\n5:((20,3),(20,5))\n5:((20,6),(20,18))\n6:((20,6),(20,7))\n6:((20,11),(20,18))\n5:((21,6),(21,14))\n6:((21,6),(21,12))\n6:((21,13),(21,14))\n1:((26,1),(26,1))\n"
    ...
    it "replaces a single token in an added span" $ do
      ...
      (drawTreeCompact f1) `shouldBe` "0:((1,1),(34,1))\n1:((1,1),(1,7))\n1:((1,8),(1,18))\n1:((1,19),(1,24))\n1:((3,1),(3,9))\n2:((3,1),(3,9))\n1:((3,10),(3,12))\n1:((3,13),(3,20))\n1:((3,21),(3,23))\n1:((3,24),(3,31))\n1:((4,1),(4,19))\n2:((4,1),(4,19))\n3:((4,1),(4,9))\n3:((4,10),(4,19))\n4:((4,10),(4,11))\n5:((4,10),(4,11))\n4:((4,12),(4,13))\n4:((4,14),(4,19))\n5:((4,14),(4,15))\n5:((4,16),(4,17))\n5:((4,18),(4,19))\n1:((6,1),(6,2))\n2:((6,1),(6,2))\n1:((6,2),(6,3))\n1:((6,3),(6,4))\n2:((6,3),(6,4))\n1:((6,5),(6,7))\n1:((6,8),(6,15))\n1:((7,1),(7,6))\n2:((7,1),(7,6))\n3:((7,1),(7,2))\n3:((7,3),(7,6))\n4:((7,3),(7,4))\n4:((7,5),(7,6))\n5:((7,5),(7,6))\n1:((8,1),(8,6))\n2:((8,1),(8,6))\n3:((8,1),(8,2))\n3:((8,3),(8,6))\n4:((8,3),(8,4))\n4:((8,5),(8,6))\n5:((8,5),(8,6))\n1:((10,1),(10,16))\n1:((11,1),(11,4))\n2:((11,1),(11,4))\n1:((11,5),(11,7))\n1:((11,8),(11,9))\n1:((11,9),(11,12))\n2:((11,9),(11,12))\n1:((11,12),(11,13))\n1:((11,14),(11,17))\n2:((11,14),(11,17))\n1:((11,17),(11,18))\n1:((12,1),(12,2))\n2:((12,1),(12,2))\n1:((12,3),(12,5))\n1:((12,6),(12,9))\n1:((13,1),(13,2))\n2:((13,1),(13,2))\n1:((13,3),(13,5))\n1:((13,6),(13,9))\n1:((14,1),(14,10))\n1:((14,11),(14,12))\n1:((14,13),(14,38))\n2:((14,13),(14,17))\n2:((14,18),(14,19))\n2:((14,20),(14,23))\n2:((14,24),(14,25))\n2:((14,25),(14,26))\n2:((14,28),(14,30))\n2:((14,32),(14,33))\n2:((14,33),(14,34))\n2:((14,36),(14,38))\n1:((15,3),(16,14))\n1:((17,5),(17,12))(Above 2 -3 (17,10) (2,-9))\n2:((17,5),(17,12))\n3:((17,5),(17,12))\n4:((17,5),(17,7))\n4:((17,8),(17,12))\n5:((17,8),(17,9))\n5:((17,10),(17,12))\n6:((17,10),(17,12))\n1:((19,1),(19,5))\n1:((19,6),(19,7))\n1:((19,8),(19,9))\n1:((19,10),(19,11))\n2:((19,10),(19,11))\n1:((19,12),(19,13))\n1:((19,14),(19,22))\n2:((19,14),(19,15))\n2:((19,16),(19,22))\n3:((19,16),(19,22))\n1:((19,23),(19,24))\n1:((19,25),(19,26))\n2:((19,25),(19,26))\n1:((21,1),(23,11))\n2:((21,1),(23,11))\n3:((21,1),(21,3))\n3:((21,4),(23,11))\n4:((21,4),(21,5))\n5:((21,4),(21,5))\n4:((21,6),(21,7))\n4:((21,8),(21,14))\n5:((21,8),(21,9))\n5:((21,10),(21,11))\n5:((21,12),(21,14))\n4:((22,3),(22,8))\n4:((23,5),(23,11))(Above 1 -3 (23,10) (2,-9))\n5:((23,5),(23,11))\n6:((23,5),(23,11))\n7:((23,5),(23,7))\n7:((23,8),(23,11))\n8:((23,8),(23,9))\n8:((23,10),(23,11))\n9:((23,10),(23,11))\n1:((25,1),(28,12))\n2:((25,1),(28,12))\n3:((25,1),(25,2))\n3:((25,3),(28,12))\n4:((25,3),(25,4))\n5:((25,3),(25,4))\n4:((25,5),(25,6))\n4:((26,3),(28,12))\n5:((26,3),(26,6))\n5:((27,5),(27,12))(Above 1 -1 (27,10) (1,-7))\n6:((27,5),(27,12))\n7:((27,5),(27,12))\n8:((27,5),(27,7))\n8:((27,8),(27,12))\n9:((27,8),(27,9))\n9:((27,10),(27,12))\n10:((27,10),(27,12))\n5:((28,3),(28,5))\n5:((28,6),(28,12))\n6:((28,6),(28,8))\n6:((28,9),(28,10))\n6:((28,11),(28,12))\n1:((30,1),(32,18))\n2:((30,1),(32,18))\n3:((30,1),(30,3))\n3:((30,4),(32,17))\n4:((30,4),(30,5))\n5:((30,4),(30,5))\n4:((30,6),(30,7))\n4:((30,8),(32,17))\n5:((30,8),(30,10))\n5:((31,3),(31,13))\n6:((31,3),(31,6))\n6:((31,7),(31,13))(Above 0 1 (31,12) (1,-9))\n7:((31,7),(31,13))\n8:((31,7),(31,13))\n9:((31,7),(31,9))\n9:((31,10),(31,13))\n10:((31,10),(31,11))\n10:((31,12),(31,13))\n11:((31,12),(31,13))\n5:((32,3),(32,17))\n6:((32,3),(32,9))\n6:((32,10),(32,11))\n6:((32,11),(32,13))\n6:((32,14),(32,15))\n6:((32,16),(32,17))\n1:((34,1),(34,1))\n"
