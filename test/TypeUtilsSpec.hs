...
-}
  ...
  describe "renamePN" $ do
    it "replaces a Name with another, updating tokens 1" $ do
      ...
      (showGhc n) `shouldBe` "DupDef.Dd1.toplevel"
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((3,1),(3,5),((((3,1),(3,5)),ITvarid \"bar2\"),\"bar2\"))]"
      (GHC.showRichTokenStream $ toks) `shouldBe` "module DupDef.Dd1 where\n\n toplevel :: Integer -> Integer\n toplevel x = c * x\n\n c,d :: Integer\n c = 7\n d = 9\n\n -- Pattern bind\n tup :: (Int, Int)\n h :: Int\n t :: Int\n tup@(h,t) = head $ zip [1..10] [3..ff]\n   where\n     ff :: Int\n     ff = 15\n\n data D = A | B String | C\n\n ff y = y + zz\n   where\n     zz = 1\n\n l z =\n   let\n     ll = 34\n   in ll + z\n\n dd q = do\n   let ss = 5\n   return (ss + q)\n\n "
      (renderLines $ linesFromState s) `shouldBe` "module DupDef.Dd1 where\n\ntoplevel :: Integer -> Integer\nbar2 x = c * x\n\nc,d :: Integer\nc = 7\nd = 9\n\n-- Pattern bind\ntup :: (Int, Int)\nh :: Int\nt :: Int\ntup@(h,t) = head $ zip [1..10] [3..ff]\n  where\n    ff :: Int\n    ff = 15\n\ndata D = A | B String | C\n\nff y = y + zz\n  where\n    zz = 1\n\nl z =\n  let\n    ll = 34\n  in ll + z\n\ndd q = do\n  let ss = 5\n  return (ss + q)\n\n"
      (showGhc nb) `shouldBe` "bar2 x = DupDef.Dd1.c GHC.Num.* x"
      (showToks $ take 20 $ toks) `shouldBe` "[((1,1),(1,7),((((1,1),(1,7)),ITmodule),\"module\")),((1,8),(1,18),((((1,8),(1,18)),ITqconid (\"DupDef\",\"Dd1\")),\"DupDef.Dd1\")),((1,19),(1,24),((((1,19),(1,24)),ITwhere),\"where\")),((3,1),(3,1),((((3,1),(3,1)),ITvocurly),\"\")),((3,1),(3,9),((((3,1),(3,9)),ITvarid \"toplevel\"),\"toplevel\")),((3,10),(3,12),((((3,10),(3,12)),ITdcolon),\"::\")),((3,13),(3,20),((((3,13),(3,20)),ITconid \"Integer\"),\"Integer\")),((3,21),(3,23),((((3,21),(3,23)),ITrarrow),\"->\")),((3,24),(3,31),((((3,24),(3,31)),ITconid \"Integer\"),\"Integer\")),((4,1),(4,1),((((4,1),(4,1)),ITsemi),\"\")),((4,1),(4,9),((((4,1),(4,9)),ITvarid \"toplevel\"),\"toplevel\")),((4,10),(4,11),((((4,10),(4,11)),ITvarid \"x\"),\"x\")),((4,12),(4,13),((((4,12),(4,13)),ITequal),\"=\")),((4,14),(4,15),((((4,14),(4,15)),ITvarid \"c\"),\"c\")),((4,16),(4,17),((((4,16),(4,17)),ITstar),\"*\")),((4,18),(4,19),((((4,18),(4,19)),ITvarid \"x\"),\"x\")),((6,1),(6,1),((((6,1),(6,1)),ITsemi),\"\")),((6,1),(6,2),((((6,1),(6,2)),ITvarid \"c\"),\"c\")),((6,2),(6,3),((((6,2),(6,3)),ITcomma),\",\")),((6,3),(6,4),((((6,3),(6,4)),ITvarid \"d\"),\"d\"))]"
      -- (showToks $ take 20 $ toksFromState s) `shouldBe` ""
    ...
    it "replaces a Name with another, updating tokens 2" $ do
      ...
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((11,21),(11,24),((((11,21),(11,24)),ITvarid \"p_1\"),\"p_1\"))]"
      ...
      (showToks $ take 20 $ toks) `shouldBe` "[((1,1),(1,7),((((1,1),(1,7)),ITmodule),\"module\")),((1,8),(1,23),((((1,8),(1,23)),ITqconid (\"Demote\",\"WhereIn4\")),\"Demote.WhereIn4\")),((1,24),(1,29),((((1,24),(1,29)),ITwhere),\"where\")),((3,1),(3,84),((((3,1),(3,84)),ITlineComment \"--A definition can be demoted to the local 'where' binding of a friend declaration,\"),\"--A definition can be demoted to the local 'where' binding of a friend declaration,\")),((4,1),(4,49),((((4,1),(4,49)),ITlineComment \"--if it is only used by this friend declaration.\"),\"--if it is only used by this friend declaration.\")),((6,1),(6,66),((((6,1),(6,66)),ITlineComment \"--Demoting a definition narrows down the scope of the definition.\"),\"--Demoting a definition narrows down the scope of the definition.\")),((7,1),(7,61),((((7,1),(7,61)),ITlineComment \"--In this example, demote the top level 'sq' to 'sumSquares'\"),\"--In this example, demote the top level 'sq' to 'sumSquares'\")),((8,1),(8,55),((((8,1),(8,55)),ITlineComment \"--In this case (there is single matches), if possible,\"),\"--In this case (there is single matches), if possible,\")),((9,1),(9,82),((((9,1),(9,82)),ITlineComment \"--the parameters will be folded after demoting and type sigature will be removed.\"),\"--the parameters will be folded after demoting and type sigature will be removed.\")),((11,1),(11,1),((((11,1),(11,1)),ITvocurly),\"\")),((11,1),(11,11),((((11,1),(11,11)),ITvarid \"sumSquares\"),\"sumSquares\")),((11,12),(11,13),((((11,12),(11,13)),ITvarid \"x\"),\"x\")),((11,14),(11,15),((((11,14),(11,15)),ITvarid \"y\"),\"y\")),((11,16),(11,17),((((11,16),(11,17)),ITequal),\"=\")),((11,18),(11,20),((((11,18),(11,20)),ITvarid \"sq\"),\"sq\")),((11,21),(11,22),((((11,21),(11,22)),ITvarid \"p\"),\"p\")),((11,23),(11,24),((((11,23),(11,24)),ITvarid \"x\"),\"x\")),((11,25),(11,26),((((11,25),(11,26)),ITvarsym \"+\"),\"+\")),((11,27),(11,29),((((11,27),(11,29)),ITvarid \"sq\"),\"sq\")),((11,30),(11,31),((((11,30),(11,31)),ITvarid \"p\"),\"p\"))]"
      -- (showToks $ take 20 $ toksFromState s) `shouldBe` ""
    ...
    it "replaces a Name with another in limited scope, updating tokens 1" $ do
      ...
      -- (show _tfo) `shouldBe` ""
      (showGhc n) `shouldBe` "TokenTest.foo"
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((19,1),(19,5),((((19,1),(19,5)),ITvarid \"bar2\"),\"bar2\"))]"
...
--
    ...
    it "replaces a name in a data declaration too" $ do
      ...
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((5,18),(5,25),((((5,18),(5,25)),ITvarid \"pointx1\"),\"pointx1\"))]"
    ...
    it "replaces a name in a type signature too" $ do
      ...
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((5,6),(5,14),((((5,6),(5,14)),ITvarid \"NewPoint\"),\"NewPoint\"))]"
      (GHC.showRichTokenStream $ toks) `shouldBe` "module Field1 where\n\n --Rename field name 'pointx' to 'pointx1'\n\n data Point = Pt {pointx, pointy :: Float}\n\n absPoint :: Point -> Float\n absPoint p = sqrt (pointx p * pointx p +\n                   pointy p * pointy p)\n\n "
    ...
    it "replace a name in a FunBind with multiple patterns" $ do
      ...
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((20,1),(20,9),((((20,1),(20,9)),ITvarid \"newPoint\"),\"newPoint\"))]"
    ...
    it "replaces a parameter name in a FunBind" $ do
      ...
      -- (showGhc $ retrieveTokensPpr $ fromJust $ layoutFromState s) `shouldBe` ""
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((8,7),(8,9),((((8,7),(8,9)),ITvarid \"ls\"),\"ls\"))]"
    ...
    it "does not qualify a name in an import hiding clause" $ do
      ...
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((4,24),(4,29),((((4,24),(4,29)),ITvarid \"mySum\"),\"mySum\"))]"
    ...
    it "does not qualify the subject of a type signature" $ do
      ...
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((5,1),(5,12),((((5,1),(5,12)),ITvarid \"myNewFringe\"),\"myNewFringe\"))]"
    ...
    it "realigns toks in a case for a longer name" $ do
      ...
      -- ((nb,nn),s) <- runRefactGhc comp $ initialLogOnState { rsModule = initRefactModule t toks }
      (showGhc n) `shouldBe` "list"
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((8,7),(8,17),((((8,7),(8,17)),ITvarid \"listlonger\"),\"listlonger\"))]"
      (GHC.showRichTokenStream $ toks) `shouldBe` "module LayoutIn2 where\n\n --Layout rule applies after 'where','let','do' and 'of'\n\n --In this Example: rename 'list' to 'ls'.\n\n silly :: [Int] -> Int\n silly list = case list of  (1:xs) -> 1\n --There is a comment\n                            (2:xs)\n                              | x < 10    -> 4  where  x = last xs\n                            otherwise -> 12\n\n "
    ...
    it "realigns toks in a do for a shorter name" $ do
      ...
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((7,8),(7,10),((((7,8),(7,10)),ITvarid \"io\"),\"io\"))]"
    ...
    it "realigns toks in a do for a longer name" $ do
      ...
      -- ((nb,nn),s) <- runRefactGhc comp $ initialLogOnState { rsModule = initRefactModule t toks }
      (showGhc n) `shouldBe` "ioFun"
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((7,8),(7,17),((((7,8),(7,17)),ITvarid \"ioFunLong\"),\"ioFunLong\"))]"
      (GHC.showRichTokenStream $ toks) `shouldBe` "module LayoutIn4 where\n\n --Layout rule applies after 'where','let','do' and 'of'\n\n --In this Example: rename 'ioFun' to  'io'\n\n main = ioFun \"hello\" where ioFun s= do  let  k = reverse s\n  --There is a comment\n                                         s <- getLine\n                                         let  q = (k ++ s)\n                                         putStr q\n                                         putStr \"foo\"\n\n "
    ...
    it "realigns toks in a where for a shorter name" $ do
      ...
      -- ((nb,nn),s) <- runRefactGhc comp $ initialLogOnState { rsModule = initRefactModule t toks }
      (showGhc n) `shouldBe` "sq"
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((7,17),(7,18),((((7,17),(7,18)),ITvarid \"q\"),\"q\"))]"
    ...
    it "realigns toks in a where for a longer name" $ do
      ...
      -- ((nb,nn),s) <- runRefactGhc comp $ initialLogOnState { rsModule = initRefactModule t toks }
      (showGhc n) `shouldBe` "sq"
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((7,17),(7,23),((((7,17),(7,23)),ITvarid \"square\"),\"square\"))]"
      (GHC.showRichTokenStream $ toks) `shouldBe` "module LayoutIn1 where\n\n --Layout rule applies after 'where','let','do' and 'of'\n\n --In this Example: rename 'sq' to 'square'.\n\n sumSquares x y= sq x + sq y where sq x= x^pow\n   --There is a comment.\n                                   pow=2\n "
      -- (pprFromState s) `shouldBe` []
    ...
    it "realigns toks in a let/in for a shorter name" $ do
      ...
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((6,5),(6,6),((((6,5),(6,6)),ITvarid \"x\"),\"x\"))]"
    ...
    it "realigns toks in a let/in for a longer name 1" $ do
      ...
      -- ((nb,nn),s) <- runRefactGhc comp $ initialLogOnState { rsModule = initRefactModule t toks }
      (showGhc n) `shouldBe` "xxx"
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((6,5),(6,12),((((6,5),(6,12)),ITvarid \"xxxlong\"),\"xxxlong\"))]"
      (GHC.showRichTokenStream $ toks) `shouldBe` "module LayoutLet1 where\n\n -- Simple let expression, rename xxx to something longer or shorter\n -- and the let/in layout should adjust accordingly\n\n foo xxx = let a = 1\n               b = 2\n           in xxx + a + b\n\n "
      -- (pprFromState s) `shouldBe` []
      (renderLines $ linesFromState s) `shouldBe` "module LayoutLet1 where\n\n-- Simple let expression, rename xxx to something longer or shorter\n-- and the let/in layout should adjust accordingly\n\nfoo xxxlong = let a = 1\n                  b = 2\n          in xxxlong + a + b\n\n"
    ...
    it "realigns toks in a let/in for a longer name 2" $ do
      ...
      -- ((nb,nn),s) <- runRefactGhc comp $ initialLogOnState { rsModule = initRefactModule t toks }
      (showGhc n) `shouldBe` "xxx"
      (showToks $ [newNameTok False l nn]) `shouldBe` "[((7,5),(7,12),((((7,5),(7,12)),ITvarid \"xxxlong\"),\"xxxlong\"))]"
  ...
  describe "getDeclAndToks" $ do
    it "returns a declaration and its associated tokens" $ do
      ...
      (showToks t) `shouldBe` "[((40,0),(40,0),((((40,0),(40,0)),ITsemi),\"\")),((40,0),(40,6),((((40,0),(40,6)),ITvarid \"tlFunc\"),\"tlFunc\")),((40,7),(40,8),((((40,7),(40,8)),ITvarid \"x\"),\"x\")),((40,9),(40,10),((((40,9),(40,10)),ITequal),\"=\")),((40,11),(40,12),((((40,11),(40,12)),ITvarid \"c\"),\"c\")),((40,13),(40,14),((((40,13),(40,14)),ITstar),\"*\")),((40,15),(40,16),((((40,15),(40,16)),ITvarid \"x\"),\"x\")),((41,0),(41,17),((((41,0),(41,17)),ITlineComment \"-- Comment at end\"),\"-- Comment at end\"))]"
