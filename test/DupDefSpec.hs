...
spec = do
  ...
  describe "doDuplicateDef" $ do
    it "checks for a clash of the new name" $ do
     ...
     res <- catchException (duplicateDef defaultTestSettings testOptions "./test/testdata/DupDef/Dd1.hs" "c" (4,1))
     -- let res = "foo"
    ...
    it "checks for no definition selected" $ do
     ...
     res <- catchException (duplicateDef defaultTestSettings testOptions "./test/testdata/DupDef/Dd1.hs" "c" (5,1))
    ...
    it "notifies if no definition selected" $ do
     ...
     res <- catchException (duplicateDef defaultTestSettings testOptions "./test/testdata/DupDef/Dd1.hs" "ccc" (14,13))
    ...
    it "duplicates a definition at the top level" $ do
     ...
     res <- duplicateDef defaultTestSettings testOptions "./test/testdata/DupDef/Dd1.hs" "tl2" (4,1)
    ...
    it "duplicates a definition in a match" $ do
     ...
     res <- duplicateDef defaultTestSettings testOptions "./test/testdata/DupDef/Dd1.hs" "mm" (23,5)
     (show res) `shouldBe` "[\"./test/testdata/DupDef/Dd1.hs\"]"
     diff <- compareFiles "./test/testdata/DupDef/Dd1.refactored.hs"
    ...
    it "duplicates a definition in a pattern match" $ do
     ...
     res <- duplicateDef defaultTestSettings testOptions "./test/testdata/DupDef/Dd1.hs" "gg" (17,5)
     (show res) `shouldBe` "[\"./test/testdata/DupDef/Dd1.hs\"]"
     diff <- compareFiles "./test/testdata/DupDef/Dd1.refactored.hs"
    ...
    it "duplicates a definition in a let expression" $ do
     ...
     res <- duplicateDef defaultTestSettings testOptions "./test/testdata/DupDef/Dd1.hs" "lll" (27,5)
     (show res) `shouldBe` "[\"./test/testdata/DupDef/Dd1.hs\"]"
     diff <- compareFiles "./test/testdata/DupDef/Dd1.refactored.hs"
    ...
    it "duplicates a definition in a let statement" $ do
     ...
     res <- duplicateDef defaultTestSettings testOptions "./test/testdata/DupDef/Dd1.hs" "sss" (31,7)
     (show res) `shouldBe` "[\"./test/testdata/DupDef/Dd1.hs\"]"
     diff <- compareFiles "./test/testdata/DupDef/Dd1.refactored.hs"
    ...
    it "hides the new definition if it will cause problems in client mods" $ do
     res <- duplicateDef (testSettingsMainfile "./test/testdata/DupDef/Dd2.hs") testOptions "./test/testdata/DupDef/Dd1.hs" "mm" (23,5)
    ...
    it "duplicates a definition and formats properly" $ do
     res <- duplicateDef defaultTestSettings testOptions "./test/testdata/Case/B.hs" "joe" (9,1)
