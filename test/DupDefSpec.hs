...
spec = do
  ...
  describe "doDuplicateDef" $ do
    ...
    it "duplicates a definition at the top level" $ do
     ...
     duplicateDef defaultTestSettings testCradle "./test/testdata/DupDef/Dd1.hs" "tl2" (4,1)
    ...
    it "duplicates a definition in a match" $ do
     ...
     duplicateDef defaultTestSettings testCradle "./test/testdata/DupDef/Dd1.hs" "mm" (23,5)
     diff <- compareFiles "./test/testdata/DupDef/Dd1.hs.refactored"
    ...
    it "duplicates a definition in a pattern match" $ do
     ...
     duplicateDef defaultTestSettings testCradle "./test/testdata/DupDef/Dd1.hs" "gg" (17,5)
     diff <- compareFiles "./test/testdata/DupDef/Dd1.hs.refactored"
    ...
    it "duplicates a definition in a let expression" $ do
     ...
     duplicateDef defaultTestSettings testCradle "./test/testdata/DupDef/Dd1.hs" "lll" (27,5)
     diff <- compareFiles "./test/testdata/DupDef/Dd1.hs.refactored"
    ...
    it "duplicates a definition in a let statement" $ do
     ...
     duplicateDef defaultTestSettings testCradle "./test/testdata/DupDef/Dd1.hs" "sss" (31,7)
     diff <- compareFiles "./test/testdata/DupDef/Dd1.hs.refactored"
                          "./test/testdata/DupDef/Dd1.hs.expected.dd"
     diff `shouldBe` []

    it "hides the new definition if it will cause problems in client mods" $ do
     duplicateDef (testSettingsMainfile "./test/testdata/DupDef/Dd2.hs") testCradle "./test/testdata/DupDef/Dd1.hs" "mm" (23,5)
     diff <- compareFiles "./test/testdata/DupDef/Dd1.hs.refactored"
                          "./test/testdata/DupDef/Dd1.hs.expected.mm"
     diff `shouldBe` []
    ...
    it "duplicates a definition and formats properly" $ do
     duplicateDef defaultTestSettings testCradle "./test/testdata/Case/B.hs" "joe" (9,1)
