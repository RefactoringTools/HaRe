...
spec = do
  ...
  describe "doDuplicateDef" $ do
    it "checks for a clash of the new name" $ do
     ...
     res <- catchException (duplicateDef defaultTestSettings testCradle Nothing "./test/testdata/DupDef/Dd1.hs" "c" (4,1))
     -- let res = "foo"
    ...
    it "checks for no definition selected" $ do
     ...
     res <- catchException (duplicateDef defaultTestSettings testCradle Nothing "./test/testdata/DupDef/Dd1.hs" "c" (5,1))
    ...
    it "notifies if no definition selected" $ do
     ...
     res <- catchException (duplicateDef defaultTestSettings testCradle Nothing "./test/testdata/DupDef/Dd1.hs" "ccc" (14,13))
    ...
    it "duplicates a definition at the top level" $ do
     ...
     duplicateDef defaultTestSettings testCradle Nothing "./test/testdata/DupDef/Dd1.hs" "tl2" (4,1)
    ...
    it "duplicates a definition in a match" $ do
     ...
     duplicateDef defaultTestSettings testCradle Nothing "./test/testdata/DupDef/Dd1.hs" "mm" (23,5)
     diff <- compareFiles "./test/testdata/DupDef/Dd1.hs.refactored"
    ...
    it "duplicates a definition in a pattern match" $ do
     ...
     duplicateDef defaultTestSettings testCradle Nothing "./test/testdata/DupDef/Dd1.hs" "gg" (17,5)
     diff <- compareFiles "./test/testdata/DupDef/Dd1.hs.refactored"
    ...
    it "duplicates a definition in a let expression" $ do
     ...
     duplicateDef defaultTestSettings testCradle Nothing "./test/testdata/DupDef/Dd1.hs" "lll" (27,5)
     diff <- compareFiles "./test/testdata/DupDef/Dd1.hs.refactored"
    ...
    it "duplicates a definition in a let statement" $ do
     ...
     duplicateDef defaultTestSettings testCradle Nothing "./test/testdata/DupDef/Dd1.hs" "sss" (31,7)
     diff <- compareFiles "./test/testdata/DupDef/Dd1.hs.refactored"
                          "./test/testdata/DupDef/Dd1.hs.expected.dd"
     diff `shouldBe` []

    it "hides the new definition if it will cause problems in client mods" $ do
     duplicateDef defaultTestSettings testCradle (Just "./test/testdata/DupDef/Dd2.hs") "./test/testdata/DupDef/Dd1.hs" "mm" (23,5)
     diff <- compareFiles "./test/testdata/DupDef/Dd1.hs.refactored"
                          "./test/testdata/DupDef/Dd1.hs.expected.mm"
     diff `shouldBe` []
    ...
    it "duplicates a definition and formats properly" $ do
     duplicateDef defaultTestSettings testCradle Nothing "./test/testdata/Case/B.hs" "joe" (9,1)
