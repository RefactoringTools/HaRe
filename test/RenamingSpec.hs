...
spec = do
  ...
  describe "Renaming" $ do
    it "renames in D1 B1 C1 A1 6 6" $ do
     r <- ct $ rename (testSettingsMainfile "./test/testdata/Renaming/A1.hs") testOptions "./test/testdata/Renaming/D1.hs" "AnotherTree" (6,6)
     -- ct $ rename logTestSettings testOptions (Just "./test/testdata/Renaming/A1.hs") "./test/testdata/Renaming/D1.hs" "AnotherTree" (6,6)
    ...
    it "renames in D2 B2 C2 A2 6 24" $ do
     r <- ct $ rename (testSettingsMainfile "./test/testdata/Renaming/A2.hs") testOptions "./test/testdata/Renaming/D2.hs" "SubTree" (6,24)
     -- rename logTestSettings testOptions (Just "./test/testdata/Renaming/A2.hs") "./test/testdata/Renaming/D2.hs" "SubTree" (6,24)
    ...
    it "renames in D3 B3 C3 A3 12 7" $ do
     ...
     r <- ct $ rename (testSettingsMainfile "./test/testdata/Renaming/A3.hs") testOptions "./test/testdata/Renaming/D3.hs" "Same" (12,7)
     -- rename (logTestSettingsMainfile "./test/testdata/Renaming/A3.hs") testOptions "./test/testdata/Renaming/D3.hs" "Same" (12,7)
    ...
    it "renames in D4 B4 C4 A4 13 4" $ do
     ...
     r <- ct $ rename (testSettingsMainfile "./test/testdata/Renaming/A4.hs") testOptions "./test/testdata/Renaming/D4.hs" "isSameOrNot" (13,4)
     -- rename logTestSettings testOptions (Just "./test/testdata/Renaming/A4.hs") "./test/testdata/Renaming/D4.hs" "isSameOrNot" (13,4)
    ...
    it "renames in D5 B5 C5 A5 24 1" $ do
     ...
     r <- ct $ rename (testSettingsMainfile "./test/testdata/Renaming/A5.hs") testOptions "./test/testdata/Renaming/D5.hs" "sum" (24,1)
     -- rename (logTestSettingsMainfile "./test/testdata/Renaming/A5.hs") testOptions "./test/testdata/Renaming/D5.hs" "sum" (24,1)
     -- rename logTestSettings testOptions "./test/testdata/Renaming/D5.hs" "sum" (24,1)
    ...
    it "renames in D7 C7  10 1" $ do
     ...
     r <- rename (testSettingsMainfile "./test/testdata/Renaming/C7.hs") testOptions "./test/testdata/Renaming/D7.hs" "myFringe" (10,1)
     -- rename logTestSettings testOptions (Just "./test/testdata/Renaming/C7.hs") "./test/testdata/Renaming/D7.hs" "myFringe" (10,1)
    ...
    it "renames in Field1 5 18" $ do
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/Field1.hs" "pointx1" (5,18)
     -- rename logTestSettings testOptions Nothing "./test/testdata/Renaming/Field1.hs" "pointx1" (5,18)
    ...
    it "renames in Field3 9 1" $ do
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/Field3.hs" "abs" (9,1)
     -- rename logTestSettings testOptions Nothing "./test/testdata/Renaming/Field3.hs" "abs" (9,1)
    ...
    it "renames in Field4 5 23" $ do
     ...
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/Field4.hs" "value2" (5,23)
    ...
    it "renames in IdIn1 11 1" $ do
     --     (["IdIn1.hs"],["x1","11","1"]),
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/IdIn1.hs" "x1" (11,1)
    ...
    it "renames in IdIn2 15 7" $ do
     --     (["IdIn2.hs"],["x1","15","7"]),
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/IdIn2.hs" "x1" (15,7)
     -- rename logTestSettings testOptions Nothing "./test/testdata/Renaming/IdIn2.hs" "x1" (15,7)
    ...
    it "renames in ClassIn1 7 7" $ do
     ...
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/ClassIn1.hs" "MyReversable" (7,7)
     -- rename logTestSettings testOptions Nothing "./test/testdata/Renaming/ClassIn1.hs" "MyReversable" (7,7)
    ...
    it "renames in ClassIn2 8 3" $ do
     ...
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/ClassIn2.hs" "reversable" (8,3)
     -- rename logTestSettings testOptions Nothing "./test/testdata/Renaming/ClassIn2.hs" "reversable" (8,3)
    ...
    it "renames in ConstructorIn1 8 6" $ do
     ...
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/ConstructorIn1.hs" "MyBTree" (8,6)
     -- rename logTestSettings testOptions "./test/testdata/Renaming/ConstructorIn1.hs" "MyBTree" (8,6)
    ...
    it "renames in ConstructorIn2 8 6" $ do
     ...
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/ConstructorIn2.hs" "Tree" (8,24)
     -- rename logTestSettings testOptions Nothing "./test/testdata/Renaming/ConstructorIn2.hs" "Tree" (8,24)
    ...
    it "renames in ConstructorIn3 9 12" $ do
     ...
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/ConstructorIn3.hs" "b" (9,13)
     -- rename logTestSettings testOptions Nothing "./test/testdata/Renaming/ConstructorIn3.hs" "b" (9,13)
    ...
    it "renames in LayoutIn1 7 17" $ do
     ...
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/LayoutIn1.hs" "square" (7,17)
     -- rename logTestSettings testOptions "./test/testdata/Renaming/LayoutIn1.hs" "square" (7,17)
    ...
    it "renames in LayoutIn2 8 7" $ do
     --     (["LayoutIn2.hs"],["ls","8","7"]),
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/LayoutIn2.hs" "ls" (8,7)
     -- rename logTestSettings testOptions Nothing "./test/testdata/Renaming/LayoutIn2.hs" "ls" (8,7)
    ...
    it "renames in LayoutIn3 7 13" $ do
     ...
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/LayoutIn3.hs" "anotherX" (7,13)
     -- rename logTestSettings testOptions "./test/testdata/Renaming/LayoutIn3.hs" "anotherX" (7,13)
    ...
    it "renames in LayoutIn4 7 8" $ do
     --     (["LayoutIn4.hs"],["io","7","8"])],
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/LayoutIn4.hs" "io" (7,8)
     -- rename logTestSettings testOptions "./test/testdata/Renaming/LayoutIn4.hs" "io" (7,8)
    ...
    it "naming clash at top level IdIn3" $ do
     -- (["IdIn3.hs"],["foo","10","1"]),
     -- rename logTestSettings testOptions Nothing "./test/testdata/Renaming/IdIn3.hs" "foo" (10,1)
     res <- catchException (rename defaultTestSettings testOptions "./test/testdata/Renaming/IdIn3.hs" "foo" (10,1))
    ...
    it "upper case name for fn fails IdIn4" $ do
     --     (["IdIn4.hs"],["Foo","12","1"]),
     -- rename logTestSettings testOptions Nothing "./test/testdata/Renaming/IdIn4.hs" "Foo" (12,1)
     res <- catchException (rename defaultTestSettings testOptions "./test/testdata/Renaming/IdIn4.hs" "Foo" (12,1))
    ...
    it "naming clash IdIn5" $ do
     --     (["IdIn5.hs"],["y","10","1"]),
     -- rename logTestSettings testOptions "./test/testdata/Renaming/IdIn5.hs" "y" (10,1)
     res <- catchException (rename defaultTestSettings testOptions "./test/testdata/Renaming/IdIn5.hs" "y" (10,1))
    ...
    it "must rename in home module ClassIn3" $ do
     ...
     -- rename logTestSettings testOptions Nothing "./test/testdata/Renaming/ClassIn3.hs" "Eq1" (16,10)
     res <- catchException (rename defaultTestSettings testOptions "./test/testdata/Renaming/ClassIn3.hs" "Eq1" (16,10))
    ...
    it "will not rename existing name Field2" $ do
     ...
     -- rename logTestSettings testOptions Nothing "./test/testdata/Renaming/Field2.hs" "absPoint" (5,18)
     res <- catchException (rename defaultTestSettings testOptions "./test/testdata/Renaming/Field2.hs" "absPoint" (5,18))
    ...
    it "must qualify clashes Qualifier" $ do
     ...
     -- rename logTestSettings testOptions "./test/testdata/Renaming/Qualifier.hs" "sum" (13,1)
     res <- catchException (rename defaultTestSettings testOptions "./test/testdata/Renaming/Qualifier.hs" "sum" (13,1))
    ...
    it "cannot rename main Main" $ do
     --     (["Main.hs"],["main1", "11","1"]),
     -- rename logTestSettings testOptions Nothing "./test/testdata/Renaming/Main.hs" "main1" (11,1)
     res <- catchException (rename defaultTestSettings testOptions "./test/testdata/Renaming/Main.hs" "main1" (11,1))
     (show res) `shouldBe` "Just \"The 'main' function defined in a 'Main' module should not be renamed!\""

    -- ---------------------------------

    it "cannot rename main Main2" $ do
     -- rename logTestSettings testOptions Nothing "./test/testdata/Renaming/Main2.hs" "main1" (4,1)
     res <- catchException (rename defaultTestSettings testOptions "./test/testdata/Renaming/Main2.hs" "main1" (4,1))
     (show res) `shouldBe` "Just \"The 'main' function defined in a 'Main' module should not be renamed!\""

    -- ---------------------------------

    it "rename with default main Main2" $ do
     -- rename logTestSettings testOptions Nothing "./test/testdata/Renaming/Main2.hs" "baz" (6,1)
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/Main2.hs" "baz" (6,1)
    ...
    it "rename in a do statement" $ do
     -- rename logTestSettings testOptions "./test/testdata/Layout/Do1.hs" "g2" (10,3)
     r <- rename defaultTestSettings testOptions "./test/testdata/Layout/Do1.hs" "g2" (10,3)
    ...
    it "renames in QualServer QualClient" $ do
     r <- rename (testSettingsMainfile "./test/testdata/Renaming/QualClient.hs") testOptions "./test/testdata/Renaming/QualServer.hs" "foo1" (11,1)
     -- rename (logTestSettingsMainfile "./test/testdata/Renaming/QualClient.hs") testOptions "./test/testdata/Renaming/QualServer.hs" "foo1" (11,1)
...
{-
    it "rename gives noRebindableInfo MoveDef" $ do
     -- rename logTestSettings testOptions "./src/Language/Haskell/Refact/MoveDef.hs" "t2" (1105,20)
     r <- rename defaultTestSettings (testOptions { cradleCabalDir = Just ".", cradleCabalFile = Just "HaRe.cabal"}) "./src/Language/Haskell/Refact/MoveDef.hs" "t2" (1105,20)
...
-}
    ...
    it "ConflictExports" $ do
     ...
     -- rename (logTestSettingsMainfile "./test/testdata/Renaming/ConflictExport.hs") testOptions "./test/testdata/Renaming/ConflictExport.hs" "fringe" (7,1)
     res <- catchException (rename (testSettingsMainfile "./test/testdata/Renaming/ConflictExport.hs") testOptions "./test/testdata/Renaming/ConflictExport.hs" "fringe" (7,1))
...
-}
    ...
    it "rename preserving layout Utils.hs" $ do
     -- rename logTestSettings testOptions "./test/testdata/Renaming/Utils.hs" "parsed1" (5,11)
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/Utils.hs" "parsed1" (5,11)
    ...
    it "passes RenameInExportedType.hs 1" $ do
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/RenameInExportedType.hs" "NewType" (6,6)
     -- rename logTestSettings testOptions "./test/testdata/Renaming/RenameInExportedType.hs" "NewType" (6,6)
    ...
    it "passes RenameInExportedType2.hs" $ do
     r <- rename defaultTestSettings testOptions "./test/testdata/Renaming/RenameInExportedType2.hs" "NewType" (6,24)
     -- rename logTestSettings testOptions "./test/testdata/Renaming/RenameInExportedType2.hs" "NewType" (6,24)
