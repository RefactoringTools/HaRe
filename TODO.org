* DONE Make the tests pass on 7.4.x.
  :PROPERTIES:
...
* DONE Make sure the command line client works
  :PROPERTIES:
  :ID:       d0de92f2-ee8c-4305-acfa-d875cf80f808
  :END:
* DONE Re-enable the elisp
  :PROPERTIES:
  :ID:       eacc1dca-2bf3-4ae6-950a-42348325e853
  :END:

* DONE Revisit DupDef, formatting not good
  :PROPERTIES:
...
** DONE implement "do-commit" the refactoring result in elisp
   [2013-07-20 Sat]
