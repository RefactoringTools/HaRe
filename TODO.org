...
** TODO check cabal support
     ...
     - [x] Cannot load multiple main modules. Consider generating the
...
** DONE renaming in MissingH-1.2.0.2/src/Control/Concurrent/Thread/Utils.hs
...
** DONE renaming in HaRe/src/Language/Haskell/Refact/Utils.hs
   - (486,6) to clientModsAndFiles1 gives
     "attempting to use module `main:Language.Haskell.Refact.Utils.DualTree'
       (/home/alanz/mysrc/github/alanz/HaRe/./src/Language/Haskell/Refact/Utils/DualTree.hs)
     which is not loaded"
