* HaRe todo
** DONE splitSubToks does not take cognizance of leading/trailing comments
...
** DONE There is a ITqvarid vs ITvarid for qualified variables
...
** DONE liftToTopLevel of liftToMod in MoveDef.hs does not remove 'where'
** TODO SwapArgs does not process client files
** TOOD demote does not process client files
