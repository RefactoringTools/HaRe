...
data TestCases = TestCases {refactorCacheCmd::String
                           ,refactorRemCacheCmd::String
                           ,refactorCmd::String
...
runTesting system hare refactorCacheCmd refactorRemCacheCmd refactorCmd positiveTests negativeTests
